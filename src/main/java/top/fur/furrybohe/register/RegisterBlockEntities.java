...
import top.fur.furrybohe.blocks.DryingRack.DryingRackBlockEntity;
...
public class RegisterBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<DryingRackBlockEntity>> DRYING_RACK_BLOCK_ENTITY = BLOCK_ENTITIES.register("drying_rack",()->BlockEntityType.Builder.of(DryingRackBlockEntity::new,RegisterBlocks.DRYING_RACK.get()).build(null));
}
